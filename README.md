...
> 🚀 **[Швидкий старт](QUICKSTART.md)** - мінімальна конфігурація для тестування
...
Бот автоматично надсилає щотижневі звіти про нові гранти щонеділі о 09:00 в налаштований канал.

### Розклад скрапінгу

Автоматичний скрапінг нових грантів виконується щонеділі о 08:00.
